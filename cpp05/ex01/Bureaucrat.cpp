...
void	Bureaucrat::signForm(Form& form)
{
	...
	{
		std::cout << this->getName() << " couldn't sign " << form.getName() << " because their grade is too low";
	}
	catch (Form::GradeTooHighException& e)
	{
		std::cout << this->getName() << " couldn't sign " << form.getName() << " because their grade is too high";
	}
